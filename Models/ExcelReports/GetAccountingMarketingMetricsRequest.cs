...
public class GetAccountingMarketingMetricsRequest
{
    ...
    internal HttpRequestMessage BuildHttpRequestMessage(string operationId)
    {
        if("get-accounting-marketing-metrics" == operationId)
        {
            ...
            queryParams.Add(QueryParamSerializer.Serialize("form",true, "showInputValues", "", this.ShowInputValues));
            ...
            var message = new HttpRequestMessage(HttpMethod.Get, $"/data/companies/{companyId}/connections/{connectionId}/assess/accountingMetrics/marketing" + queryParamString);
            return message;
        }
