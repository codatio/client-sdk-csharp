...
public class GetCommerceCustomerRetentionMetricsRequest
{
    ...
    internal HttpRequestMessage BuildHttpRequestMessage(string operationId)
    {
        if("get-commerce-customer-retention-metrics" == operationId)
        {
            ...
            var message = new HttpRequestMessage(HttpMethod.Get, $"/data/companies/{companyId}/connections/{connectionId}/assess/commerceMetrics/customerRetention" + queryParamString);
            return message;
        }
