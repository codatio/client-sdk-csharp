...
public class GetCommerceLifetimeValueMetricsRequest
{
    ...
    {
        if("get-commerce-lifetime-value-metrics" == operationId)
        {
            ...
            var message = new HttpRequestMessage(HttpMethod.Get, $"/data/companies/{companyId}/connections/{connectionId}/assess/commerceMetrics/lifetimeValue" + queryParamString);
            return message;
        }
        throw new ArgumentException($"Attempt to build HttpRequestMessage for invalid operationId [{operationId}] for request type [GetCommerceLifetimeValueMetricsRequest]");
    }
}
