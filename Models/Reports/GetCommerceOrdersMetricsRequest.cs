...
public class GetCommerceOrdersMetricsRequest
{
    ...
    {
        if("get-commerce-orders-metrics" == operationId)
        {
            ...
            var message = new HttpRequestMessage(HttpMethod.Get, $"/data/companies/{companyId}/connections/{connectionId}/assess/commerceMetrics/orders" + queryParamString);
            return message;
        }
        throw new ArgumentException($"Attempt to build HttpRequestMessage for invalid operationId [{operationId}] for request type [GetCommerceOrdersMetricsRequest]");
    }
}
