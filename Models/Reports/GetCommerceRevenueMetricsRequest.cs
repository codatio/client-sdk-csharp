...
public class GetCommerceRevenueMetricsRequest
{
    ...
    {
        if("get-commerce-revenue-metrics" == operationId)
        {
            ...
            var message = new HttpRequestMessage(HttpMethod.Get, $"/data/companies/{companyId}/connections/{connectionId}/assess/commerceMetrics/revenue" + queryParamString);
            return message;
        }
        throw new ArgumentException($"Attempt to build HttpRequestMessage for invalid operationId [{operationId}] for request type [GetCommerceRevenueMetricsRequest]");
    }
}
