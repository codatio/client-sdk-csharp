    ...
    public class Companies: ICompanies
    {
        ...
        )
        {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var httpResponseBody = await httpResponse.Content.ReadAsStringAsync();
                    Models.Shared.Companies obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<Models.Shared.Companies>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into Models.Shared.Companies.", httpResponse, httpResponseBody, ex);
                    }
