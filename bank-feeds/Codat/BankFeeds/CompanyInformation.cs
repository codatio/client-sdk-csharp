...
namespace Codat.BankFeeds
{
    ...
    public interface ICompanyInformation
    {
        ...
        /// 
        /// <remarks>
        /// Use the *Get company information* endpoint to return information about the company available from the underlying accounting platform.<br/>
        /// <br/>
        /// 
        /// </remarks>
        /// </summary>
        Task<GetCompanyInformationResponse> GetAsync(GetCompanyInformationRequest request);
    }
    ...
    public class CompanyInformation: ICompanyInformation
    {
        ...
        public CompanyInformation(ISpeakeasyHttpClient defaultClient, Func<Security>? securitySource, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<GetCompanyInformationResponse> GetAsync(GetCompanyInformationRequest request)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/connections/{connectionId}/bankFeeds/info", request);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Models.Shared.CompanyInformation>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
