...
namespace Codat.BankFeeds
{
    ...
    public class CompanyInformation: ICompanyInformation
    {
        ...
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/connections/{connectionId}/bankFeeds/info", request, null);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    Models.Shared.CompanyInformation obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<Models.Shared.CompanyInformation>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into Models.Shared.CompanyInformation.", httpResponse, httpResponseBody, ex);
                    }
