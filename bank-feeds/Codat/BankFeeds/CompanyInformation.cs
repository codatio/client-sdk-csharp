...
namespace Codat.BankFeeds
{
    ...
    public class CompanyInformation: ICompanyInformation
    {
        ...
        public CompanyInformation(ISpeakeasyHttpClient client, Func<Codat.BankFeeds.Models.Shared.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<GetCompanyInformationResponse> GetAsync(GetCompanyInformationRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "get-company-information", new List<string> {  }, _securitySource);
