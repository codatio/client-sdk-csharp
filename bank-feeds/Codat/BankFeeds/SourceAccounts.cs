...
namespace Codat.BankFeeds
{
    ...
    public interface ISourceAccounts
    {
        ...
        /// </remarks>
        /// </summary>
        Task<CreateSourceAccountResponse> CreateAsync(CreateSourceAccountRequest request);
        ...
        /// </remarks>
        /// </summary>
        Task<DeleteSourceAccountResponse> DeleteAsync(DeleteSourceAccountRequest request);
        ...
        /// </remarks>
        /// </summary>
        Task<DeleteBankFeedCredentialsResponse> DeleteCredentialsAsync(DeleteBankFeedCredentialsRequest request);
        ...
        /// </remarks>
        /// </summary>
        Task<ListSourceAccountsResponse> ListAsync(ListSourceAccountsRequest request);
        ...
        /// </remarks>
        /// </summary>
        Task<UpdateSourceAccountResponse> UpdateAsync(UpdateSourceAccountRequest request);
    }
    ...
    public class SourceAccounts: ISourceAccounts
    {
        ...
        public SourceAccounts(ISpeakeasyHttpClient defaultClient, Func<Security>? securitySource, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<CreateSourceAccountResponse> CreateAsync(CreateSourceAccountRequest request)
        {
        ...
        public async Task<DeleteSourceAccountResponse> DeleteAsync(DeleteSourceAccountRequest request)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
        ...
        public async Task<DeleteBankFeedCredentialsResponse> DeleteCredentialsAsync(DeleteBankFeedCredentialsRequest request)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
        ...
        public async Task<ListSourceAccountsResponse> ListAsync(ListSourceAccountsRequest request)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/connections/{connectionId}/connectionInfo/bankFeedAccounts", request);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<List<SourceAccount>>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<UpdateSourceAccountResponse> UpdateAsync(UpdateSourceAccountRequest request)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/connections/{connectionId}/connectionInfo/bankFeedAccounts/{accountId}", request);
