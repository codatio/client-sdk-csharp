    ...
    public class SourceAccountsSDK: ISourceAccountsSDK
    {
        ...
        public async Task<CreateSourceAccountResponse> CreateAsync(CreateSourceAccountRequest? request = null)
        {
            ...
            if((response.StatusCode == 200))
            {
                ...
                {
                    response.SourceAccount = JsonConvert.DeserializeObject<Dictionary<string, object>>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
