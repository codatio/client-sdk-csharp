...
namespace Codat.Lending
{
    ...
    public interface IAccountingBankData
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="ListAccountingBankAccountTransactionsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="ListAccountingBankAccountTransactionsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<ListAccountingBankAccountTransactionsResponse> ListTransactionsAsync(
    ...
    public class AccountingBankData: IAccountingBankData
    {
        ...
        /// <summary>
        /// Accounts SubSDK.
        /// <see cref="ICodatLendingAccounts"/>
        /// </summary>
        ...
        /// <exception cref="ErrorMessage">Your `query` parameter was not correctly formed. Thrown when the API returns a 400, 401, 402, 403, 404, 409, 429, 500 or 503 response.</exception>
        /// <exception cref="SDKException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<ListAccountingBankAccountTransactionsResponse> ListTransactionsAsync(
            ListAccountingBankAccountTransactionsRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/connections/{connectionId}/data/bankAccounts/{accountId}/bankTransactions", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list-accounting-bank-account-transactions", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    AccountingBankTransactions obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<AccountingBankTransactions>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into AccountingBankTransactions.", httpResponse, httpResponseBody, ex);
                    }
