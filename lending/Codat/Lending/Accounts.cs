...
namespace Codat.Lending
{
    ...
    public interface IAccounts
    {
        ...
        /// </remarks>
        /// </summary>
        Task<ListAccountingAccountsResponse> ListAsync(ListAccountingAccountsRequest request, RetryConfig? retryConfig = null);
        ...
        /// </remarks>
        /// </summary>
        Task<GetAccountingAccountResponse> GetAsync(GetAccountingAccountRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Accounts: IAccounts
    {
        ...
        public async Task<ListAccountingAccountsResponse> ListAsync(ListAccountingAccountsRequest request, RetryConfig? retryConfig = null)
        {
            if (request == null) throw new ArgumentNullException(nameof(request));

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/data/accounts", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list-accounting-accounts", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<AccountingAccounts>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into AccountingAccounts.", httpResponse, httpResponseBody, ex);
                    }
        ...
        public async Task<GetAccountingAccountResponse> GetAsync(GetAccountingAccountRequest request, RetryConfig? retryConfig = null)
        {
            if (request == null) throw new ArgumentNullException(nameof(request));

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/data/accounts/{accountId}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get-accounting-account", null, SDKConfiguration.SecuritySource);
