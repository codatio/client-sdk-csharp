...
namespace Codat.Lending
{
    ...
    public class BalanceSheet: IBalanceSheet
    {
        ...
        public async Task<GetCategorizedBalanceSheetStatementResponse> GetCategorizedAccountsAsync(GetCategorizedBalanceSheetStatementRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/reports/enhancedBalanceSheet/accounts", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get-categorized-balance-sheet-statement", null, SDKConfiguration.SecuritySource);
        ...
        public async Task<GetAccountingBalanceSheetResponse> GetAsync(GetAccountingBalanceSheetRequest request, RetryConfig? retryConfig = null)
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/data/financials/balanceSheet", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get-accounting-balance-sheet", null, SDKConfiguration.SecuritySource);
