...
namespace Codat.Lending
{
    ...
    public class BankAccounts: IBankAccounts
    {
        ...
        public BankAccounts(ISpeakeasyHttpClient client, Func<Codat.Lending.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<GetCreateUpdateBankAccountsModelResponse> GetCreateUpdateModelAsync(GetCreateUpdateBankAccountsModelRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("get-create-update-bankAccounts-model", null, _securitySource);
        ...
        public async Task<CreateBankAccountResponse> CreateAsync(CreateBankAccountRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<AccountingCreateBankAccountResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
