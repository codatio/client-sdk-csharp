...
namespace Codat.Lending
{
    ...
    public interface IBankAccounts
    {
        ...
        /// </remarks>
        /// </summary>
        Task<GetCreateUpdateBankAccountsModelResponse> GetCreateUpdateModelAsync(GetCreateUpdateBankAccountsModelRequest request);
    }
    ...
    public class BankAccounts: IBankAccounts
    {
        ...
        public async Task<GetCreateUpdateBankAccountsModelResponse> GetCreateUpdateModelAsync(GetCreateUpdateBankAccountsModelRequest request)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
