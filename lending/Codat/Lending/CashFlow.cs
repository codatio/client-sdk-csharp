...
namespace Codat.Lending
{
    ...
    public class CashFlow: ICashFlow
    {
        ...
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/data/financials/cashFlowStatement", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get-accounting-cash-flow-statement", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    AccountingCashFlowStatement obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<AccountingCashFlowStatement>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into AccountingCashFlowStatement.", httpResponse, httpResponseBody, ex);
                    }
