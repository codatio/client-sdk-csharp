...
namespace Codat.Lending
{
    ...
    public class CategorizedStatement: ICategorizedStatement
    {
        ...
        public CategorizedStatement(ISpeakeasyHttpClient client, Func<Codat.Lending.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
