...
namespace Codat.Lending
{
    ...
    public interface ICategorizedStatement
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="GetCategorizedBankStatementRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="GetCategorizedBankStatementResponse"/> response envelope when completed.</returns>
        ...
        public  Task<GetCategorizedBankStatementResponse> GetAsync(
    ...
    public class CategorizedStatement: ICategorizedStatement
    {
        ...
        /// <exception cref="ErrorMessage">Your `query` parameter was not correctly formed. Thrown when the API returns a 400, 401, 402, 403, 404, 429, 500 or 503 response.</exception>
        /// <exception cref="SDKException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<GetCategorizedBankStatementResponse> GetAsync(
            GetCategorizedBankStatementRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/reports/enhancedCashFlow/transactions", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get-categorized-bank-statement", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    EnhancedCashFlowTransactions obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<EnhancedCashFlowTransactions>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into EnhancedCashFlowTransactions.", httpResponse, httpResponseBody, ex);
                    }
