...
namespace Codat.Lending
{
    ...
    public class CodatLendingBankingAccounts: ICodatLendingBankingAccounts
    {
        ...
        public CodatLendingBankingAccounts(ISpeakeasyHttpClient client, Func<Codat.Lending.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
