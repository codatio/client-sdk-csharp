...
namespace Codat.Lending
{
    ...
    public class CodatLendingCustomers: ICodatLendingCustomers
    {
        ...
        public CodatLendingCustomers(ISpeakeasyHttpClient client, Func<Codat.Lending.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<ListCommerceCustomersResponse> ListAsync(ListCommerceCustomersRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("list-commerce-customers", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<CommerceCustomers>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<GetCommerceCustomerResponse> GetAsync(GetCommerceCustomerRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("get-commerce-customer", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<CommerceCustomer>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
