...
namespace Codat.Lending
{
    ...
    public interface ICodatLendingFinancialStatementsAccounts
    {
        ...
        /// </remarks>
        /// </summary>
        Task<GetAccountingAccountResponse> GetAsync(GetAccountingAccountRequest request);
        ...
        /// </remarks>
        /// </summary>
        Task<ListAccountingAccountsResponse> ListAsync(ListAccountingAccountsRequest request);
    }
    ...
    public class CodatLendingFinancialStatementsAccounts: ICodatLendingFinancialStatementsAccounts
    {
        ...
        public async Task<GetAccountingAccountResponse> GetAsync(GetAccountingAccountRequest request)
        {
            ...
            var hookCtx = new HookContext("get-accounting-account", null, _securitySource);
        ...
        public async Task<ListAccountingAccountsResponse> ListAsync(ListAccountingAccountsRequest request)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            ...
            var hookCtx = new HookContext("list-accounting-accounts", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<AccountingAccounts>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
