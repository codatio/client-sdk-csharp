...
namespace Codat.Lending
{
    ...
    public class CodatLendingLoanWritebackAccounts: ICodatLendingLoanWritebackAccounts
    {
        ...
        public CodatLendingLoanWritebackAccounts(ISpeakeasyHttpClient client, Func<Codat.Lending.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<CreateAccountResponse> CreateAsync(CreateAccountRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<AccountingCreateAccountResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
