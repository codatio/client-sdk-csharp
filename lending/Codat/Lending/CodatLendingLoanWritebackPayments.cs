...
namespace Codat.Lending
{
    ...
    public interface ICodatLendingLoanWritebackPayments
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="GetCreatePaymentModelRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="GetCreatePaymentModelResponse"/> response envelope when completed.</returns>
        ...
        public  Task<GetCreatePaymentModelResponse> GetCreateModelAsync(
        ...
        /// <exception cref="SDKException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<CreatePaymentResponse> CreateAsync(CreatePaymentRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class CodatLendingLoanWritebackPayments: ICodatLendingLoanWritebackPayments
    {
        ...
        /// <exception cref="ErrorMessage">Your API request was not properly authorized. Thrown when the API returns a 401, 402, 403, 404, 429, 500 or 503 response.</exception>
        /// <exception cref="SDKException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<GetCreatePaymentModelResponse> GetCreateModelAsync(
            GetCreatePaymentModelRequest request,
            RetryConfig? retryConfig = null
        )
        {
