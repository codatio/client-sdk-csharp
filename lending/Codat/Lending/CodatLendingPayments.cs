...
namespace Codat.Lending
{
    ...
    public class CodatLendingPayments: ICodatLendingPayments
    {
        ...
        public CodatLendingPayments(ISpeakeasyHttpClient client, Func<Codat.Lending.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<ListCommercePaymentsResponse> ListAsync(ListCommercePaymentsRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("list-commerce-payments", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<CommercePayments>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<GetCommercePaymentResponse> GetAsync(GetCommercePaymentRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("get-commerce-payment", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<CommercePayment>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
