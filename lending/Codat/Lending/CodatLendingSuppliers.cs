...
namespace Codat.Lending
{
    ...
    public interface ICodatLendingSuppliers
    {
        ...
        /// </remarks>
        /// </summary>
        Task<GetCreateUpdateSuppliersModelResponse> GetCreateUpdateModelAsync(GetCreateUpdateSuppliersModelRequest request);
    }
    ...
    public class CodatLendingSuppliers: ICodatLendingSuppliers
    {
        ...
        public CodatLendingSuppliers(ISpeakeasyHttpClient defaultClient, Func<Security>? securitySource, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<GetCreateUpdateSuppliersModelResponse> GetCreateUpdateModelAsync(GetCreateUpdateSuppliersModelRequest request)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
