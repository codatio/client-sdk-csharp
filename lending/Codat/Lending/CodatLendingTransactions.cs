...
namespace Codat.Lending
{
    ...
    public class CodatLendingTransactions: ICodatLendingTransactions
    {
        ...
        public CodatLendingTransactions(ISpeakeasyHttpClient client, Func<Codat.Lending.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<ListBankingTransactionsResponse> ListAsync(ListBankingTransactionsRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("list-banking-transactions", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<BankingTransactions>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<GetBankingTransactionResponse> GetAsync(GetBankingTransactionRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("get-banking-transaction", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<BankingTransaction>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
