...
namespace Codat.Lending
{
    ...
    public class JournalEntries: IJournalEntries
    {
        ...
        public JournalEntries(ISpeakeasyHttpClient client, Func<Codat.Lending.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<ListAccountingJournalEntriesResponse> ListAsync(ListAccountingJournalEntriesRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("list-accounting-journal-entries", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<AccountingJournalEntries>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<GetAccountingJournalEntryResponse> GetAsync(GetAccountingJournalEntryRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("get-accounting-journal-entry", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<AccountingJournalEntry>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
