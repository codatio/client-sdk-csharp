...
namespace Codat.Lending
{
    ...
    public class Journals: IJournals
    {
        ...
        public Journals(ISpeakeasyHttpClient client, Func<Codat.Lending.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<ListAccountingJournalsResponse> ListAsync(ListAccountingJournalsRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("list-accounting-journals", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<AccountingJournals>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<GetAccountingJournalResponse> GetAsync(GetAccountingJournalRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("get-accounting-journal", null, _securitySource);
