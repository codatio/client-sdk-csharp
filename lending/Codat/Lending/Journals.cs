...
namespace Codat.Lending
{
    ...
    public interface IJournals
    {
        ...
        /// </remarks>
        /// </summary>
        Task<ListAccountingJournalsResponse> ListAsync(ListAccountingJournalsRequest request, RetryConfig? retryConfig = null);
        ...
        /// </remarks>
        /// </summary>
        Task<GetAccountingJournalResponse> GetAsync(GetAccountingJournalRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Journals: IJournals
    {
        ...
        public async Task<ListAccountingJournalsResponse> ListAsync(ListAccountingJournalsRequest request, RetryConfig? retryConfig = null)
        {
            if (request == null) throw new ArgumentNullException(nameof(request));

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/data/journals", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list-accounting-journals", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<AccountingJournals>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into AccountingJournals.", httpResponse, httpResponseBody, ex);
                    }
        ...
        public async Task<GetAccountingJournalResponse> GetAsync(GetAccountingJournalRequest request, RetryConfig? retryConfig = null)
        {
            if (request == null) throw new ArgumentNullException(nameof(request));

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/data/journals/{journalId}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get-accounting-journal", null, SDKConfiguration.SecuritySource);
