...
namespace Codat.Lending
{
    ...
    public interface IManageReports
    {
        ...
        /// 
        /// <remarks>
        /// &gt; **Available as beta release**<br/>
        /// &gt;<br/>
        /// &gt; This endpoint is part of a beta release. Please contact your account manager if you want to enable it.<br/>
        /// <br/>
    ...
    public class ManageReports: IManageReports
    {
        ...
        public ManageReports(ISpeakeasyHttpClient client, Func<Codat.Lending.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<GenerateReportResponse> GenerateReportAsync(GenerateReportRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/reports/{reportType}", request);
            ...
            var hookCtx = new HookContext("generate-report", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<ReportOperation>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/reports", request);
            ...
            var hookCtx = new HookContext("list-reports", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Models.Components.Reports>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
