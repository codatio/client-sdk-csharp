...
namespace Codat.Lending.Models.Components
{
    ...
    /// &gt; Linked payments<br/>
    /// &gt; <br/>
    /// &gt; Not all accounting software support linked payments in this way. In these platforms you may see a payment on account and a refund on account.<br/>
    /// <br/>
    ...
    public class AccountingBillPayment
    {
        ...
        /// </summary>
        [JsonProperty("lines")]
        public List<BillPaymentLine>? Lines { get; set; } = null;
