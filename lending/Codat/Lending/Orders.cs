...
namespace Codat.Lending
{
    ...
    public interface IOrders
    {
        ...
        /// </remarks>
        /// </summary>
        Task<GetCommerceOrderResponse> GetAsync(GetCommerceOrderRequest request);
        ...
        /// </remarks>
        /// </summary>
        Task<ListCommerceOrdersResponse> ListAsync(ListCommerceOrdersRequest request);
    }
    ...
    public class Orders: IOrders
    {
        ...
        public async Task<GetCommerceOrderResponse> GetAsync(GetCommerceOrderRequest request)
        {
            ...
            var hookCtx = new HookContext("get-commerce-order", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<CommerceOrder>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<ListCommerceOrdersResponse> ListAsync(ListCommerceOrdersRequest request)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            ...
            var hookCtx = new HookContext("list-commerce-orders", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<CommerceOrders>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
