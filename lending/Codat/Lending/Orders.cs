...
namespace Codat.Lending
{
    ...
    public class Orders: IOrders
    {
        ...
        public async Task<ListCommerceOrdersResponse> ListAsync(ListCommerceOrdersRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/connections/{connectionId}/data/commerce-orders", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list-commerce-orders", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<CommerceOrders>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into CommerceOrders.", httpResponse, httpResponseBody, ex);
                    }
        ...
        public async Task<GetCommerceOrderResponse> GetAsync(GetCommerceOrderRequest request, RetryConfig? retryConfig = null)
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/connections/{connectionId}/data/commerce-orders/{orderId}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get-commerce-order", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<CommerceOrder>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into CommerceOrder.", httpResponse, httpResponseBody, ex);
                    }
