...
namespace Codat.Lending
{
    ...
    public interface IPayments
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="ListAccountingPaymentsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="ListAccountingPaymentsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<ListAccountingPaymentsResponse> ListAsync(
        ...
        /// Before using this endpoint, you must have <a href="https://docs.codat.io/lending-api#/operations/refresh-company-data">retrieved data for the company</a>.
        /// </remarks>
        /// <param name="request">A <see cref="GetAccountingPaymentRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="GetAccountingPaymentResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="request"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        ...
        /// <exception cref="SDKException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<GetAccountingPaymentResponse> GetAsync(
    ...
    public class Payments: IPayments
    {
        ...
        /// <exception cref="ErrorMessage">Your `query` parameter was not correctly formed. Thrown when the API returns a 400, 401, 402, 403, 404, 409, 429, 500 or 503 response.</exception>
        /// <exception cref="SDKException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<ListAccountingPaymentsResponse> ListAsync(
            ListAccountingPaymentsRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/data/payments", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list-accounting-payments", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    AccountingPayments obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<AccountingPayments>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into AccountingPayments.", httpResponse, httpResponseBody, ex);
                    }
        ...
        /// <exception cref="ErrorMessage">Your API request was not properly authorized. Thrown when the API returns a 401, 402, 403, 404, 409, 429, 500 or 503 response.</exception>
        /// <exception cref="SDKException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<GetAccountingPaymentResponse> GetAsync(
            GetAccountingPaymentRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/data/payments/{paymentId}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get-accounting-payment", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var httpResponseBody = await httpResponse.Content.ReadAsStringAsync();
                    AccountingPayment obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<AccountingPayment>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into AccountingPayment.", httpResponse, httpResponseBody, ex);
                    }
