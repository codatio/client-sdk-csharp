...
namespace Codat.Lending
{
    ...
    public class ProfitAndLoss: IProfitAndLoss
    {
        ...
        public ProfitAndLoss(ISpeakeasyHttpClient client, Func<Codat.Lending.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<GetCategorizedProfitAndLossStatementResponse> GetCategorizedAccountsAsync(GetCategorizedProfitAndLossStatementRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("get-categorized-profit-and-loss-statement", null, _securitySource);
        ...
        public async Task<GetAccountingProfitAndLossResponse> GetAsync(GetAccountingProfitAndLossRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("get-accounting-profit-and-loss", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<AccountingProfitAndLossReport>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
