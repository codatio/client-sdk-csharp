...
namespace Codat.Lending
{
    ...
    public class PullOperations: IPullOperations
    {
        ...
        public PullOperations(ISpeakeasyHttpClient client, Func<Codat.Lending.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<ListPullOperationsResponse> ListAsync(ListPullOperationsRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Models.Components.PullOperations>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
