...
namespace Codat.Lending
{
    ...
    public class Reports: IReports
    {
        ...
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/data/companies/{companyId}/connections/{connectionId}/assess/commerceMetrics/orders", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get-commerce-orders-report", null, SDKConfiguration.SecuritySource);
        ...
        )
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/data/companies/{companyId}/connections/{connectionId}/assess/commerceMetrics/refunds", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get-commerce-refunds-report", null, SDKConfiguration.SecuritySource);
