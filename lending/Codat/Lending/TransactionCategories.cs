...
namespace Codat.Lending
{
    ...
    public interface ITransactionCategories
    {
        ...
        /// </remarks>
        /// </summary>
        Task<GetBankingTransactionCategoryResponse> GetAsync(GetBankingTransactionCategoryRequest request);
        ...
        /// </remarks>
        /// </summary>
        Task<ListBankingTransactionCategoriesResponse> ListAsync(ListBankingTransactionCategoriesRequest request);
    }
    ...
    public class TransactionCategories: ITransactionCategories
    {
        ...
        public TransactionCategories(ISpeakeasyHttpClient defaultClient, Func<Security>? securitySource, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<GetBankingTransactionCategoryResponse> GetAsync(GetBankingTransactionCategoryRequest request)
        {
            ...
            var hookCtx = new HookContext("get-banking-transaction-category", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<BankingTransactionCategory>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<ListBankingTransactionCategoriesResponse> ListAsync(ListBankingTransactionCategoriesRequest request)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            ...
            var hookCtx = new HookContext("list-banking-transaction-categories", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<BankingTransactionCategories>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
