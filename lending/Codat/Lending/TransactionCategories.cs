...
namespace Codat.Lending
{
    ...
    public class TransactionCategories: ITransactionCategories
    {
        ...
        public async Task<ListBankingTransactionCategoriesResponse> ListAsync(ListBankingTransactionCategoriesRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/connections/{connectionId}/data/banking-transactionCategories", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list-banking-transaction-categories", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    BankingTransactionCategories obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<BankingTransactionCategories>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into BankingTransactionCategories.", httpResponse, httpResponseBody, ex);
                    }
                    ...
                    response.BankingTransactionCategories = obj;
                    return response;
                }
        ...
        public async Task<GetBankingTransactionCategoryResponse> GetAsync(GetBankingTransactionCategoryRequest request, RetryConfig? retryConfig = null)
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/connections/{connectionId}/data/banking-transactionCategories/{transactionCategoryId}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get-banking-transaction-category", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var httpResponseBody = await httpResponse.Content.ReadAsStringAsync();
                    BankingTransactionCategory obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<BankingTransactionCategory>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into BankingTransactionCategory.", httpResponse, httpResponseBody, ex);
                    }
                    ...
                    response.BankingTransactionCategory = obj;
                    return response;
                }
