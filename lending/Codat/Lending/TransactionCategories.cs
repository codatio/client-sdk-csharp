...
namespace Codat.Lending
{
    ...
    public class TransactionCategories: ITransactionCategories
    {
        ...
        public TransactionCategories(ISpeakeasyHttpClient client, Func<Codat.Lending.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
