...
namespace CodatLending
{
    ...
    public class FinancialStatementsBalanceSheetSDK: IFinancialStatementsBalanceSheetSDK
    {
        ...
        public FinancialStatementsBalanceSheetSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
