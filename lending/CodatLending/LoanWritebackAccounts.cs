    ...
    public class LoanWritebackAccountsSDK: ILoanWritebackAccountsSDK
    {
        ...
        public async Task<CreateAccountResponse> CreateAsync(CreateAccountRequest? request = null)
        {
            ...
            if((response.StatusCode == 200))
            {
                ...
                {
                    response.AccountingCreateAccountResponse = JsonConvert.DeserializeObject<AccountingCreateAccountResponse>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer() }});
                }
