    ...
    public class LoanWritebackBankTransactionsSDK: ILoanWritebackBankTransactionsSDK
    {
        ...
        public async Task<CreateBankTransactionsResponse> CreateAsync(CreateBankTransactionsRequest? request = null)
        {
            ...
            if((response.StatusCode == 200))
            {
                ...
                {
                    response.AccountingCreateBankTransactionsResponse = JsonConvert.DeserializeObject<AccountingCreateBankTransactionsResponse>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer() }});
                }
