...
namespace CodatLending
{
    ...
    public interface ILoanWritebackCreateOperationsSDK
    {
    ...
    public class LoanWritebackCreateOperationsSDK: ILoanWritebackCreateOperationsSDK
    {
        ...
        public LoanWritebackCreateOperationsSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
