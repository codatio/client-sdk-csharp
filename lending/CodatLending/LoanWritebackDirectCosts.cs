    ...
    public class LoanWritebackDirectCostsSDK: ILoanWritebackDirectCostsSDK
    {
        ...
        public async Task<CreateDirectCostResponse> CreateAsync(CreateDirectCostRequest? request = null)
        {
            ...
            if((response.StatusCode == 200))
            {
                ...
                {
                    response.AccountingCreateDirectCostResponse = JsonConvert.DeserializeObject<AccountingCreateDirectCostResponse>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer() }});
                }
