...
namespace CodatLending
{
    ...
    public interface ILoanWritebackDirectCostsSDK
    {
    ...
    public class LoanWritebackDirectCostsSDK: ILoanWritebackDirectCostsSDK
    {
        ...
        public LoanWritebackDirectCostsSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<CreateDirectCostResponse> CreateAsync(CreateDirectCostRequest? request = null)
        {
            ...
            var serializedBody = RequestBodySerializer.Serialize(request, "AccountingDirectCost", "json");
