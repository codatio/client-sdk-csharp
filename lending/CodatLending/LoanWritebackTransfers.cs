...
namespace CodatLending
{
    ...
    public interface ILoanWritebackTransfersSDK
    {
        ...
        /// 
        /// <remarks>
        /// The *Create transfer* endpoint creates a new <a href="https://docs.codat.io/accounting-api#/schemas/Transfer">transfer</a> for a given company&apos;s connection.<br/>
        /// <br/>
        ...
        /// <br/>
        /// Required data may vary by integration. To see what data to post, first call <a href="https://docs.codat.io/accounting-api#/operations/get-create-transfers-model">Get create transfer model</a>.<br/>
        /// <br/>
        ...
        /// 
        /// <remarks>
        /// The *Get create transfer model* endpoint returns the expected data for the request payload when creating a <a href="https://docs.codat.io/accounting-api#/schemas/Transfer">transfer</a> for a given company and integration.<br/>
        /// <br/>
        /// <a href="https://docs.codat.io/accounting-api#/schemas/Transfer">Transfers</a> record the movement of money between two bank accounts, or between a bank account and a nominal account.<br/>
        /// <br/>
        /// **Integration-specific behaviour**<br/>
    ...
    public class LoanWritebackTransfersSDK: ILoanWritebackTransfersSDK
    {
        ...
        public LoanWritebackTransfersSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<CreateTransferResponse> CreateAsync(CreateTransferRequest? request = null)
        {
            ...
            if((response.StatusCode == 200))
            {
                ...
                {
                    response.AccountingCreateTransferResponse = JsonConvert.DeserializeObject<AccountingCreateTransferResponse>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer() }});
                }
