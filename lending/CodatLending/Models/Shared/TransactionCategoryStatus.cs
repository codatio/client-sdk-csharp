...
namespace Codat.Lending.Models.Shared
{
    ...
    public static class TransactionCategoryStatusExtension
    {
        ...
        public static TransactionCategoryStatus ToEnum(this string value)
        {
            foreach(var field in typeof(TransactionCategoryStatus).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is TransactionCategoryStatus)
                    {
                        return (TransactionCategoryStatus)enumVal;
                    }
                }
            }
