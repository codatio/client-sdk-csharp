...
namespace Codat.Lending.Models.Shared
{
    ...
    public static class TransactionSourceTypeExtension
    {
        ...
        public static TransactionSourceType ToEnum(this string value)
        {
            foreach(var field in typeof(TransactionSourceType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is TransactionSourceType)
                    {
                        return (TransactionSourceType)enumVal;
                    }
                }
            }
