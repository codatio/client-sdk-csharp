...
<!-- UsageSnippet language="csharp" operationID="get-create-update-bankAccounts-model" method="get" path="/companies/{companyId}/connections/{connectionId}/options/bankAccounts" -->
```csharp
using Codat.Lending;
