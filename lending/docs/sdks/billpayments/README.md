...
<!-- UsageSnippet language="csharp" operationID="list-accounting-bill-payments" method="get" path="/companies/{companyId}/data/billPayments" -->
```csharp
using Codat.Lending;
...
<!-- UsageSnippet language="csharp" operationID="get-accounting-bill-payment" method="get" path="/companies/{companyId}/data/billPayments/{billPaymentId}" -->
```csharp
using Codat.Lending;
using Codat.Lending.Models.Components;
using Codat.Lending.Models.Requests;
