...
var res = await sdk.CashFlow.GetBankAccountAsync(new GetBankingAccountRequest() {
    AccountId = "molestiae",
...
var res = await sdk.CashFlow.GetBankTransactionAsync(new GetBankingTransactionRequest() {
    CompanyId = "8a210b68-6988-11ed-a1eb-0242ac120002",
    ConnectionId = "2e9d2c44-f675-40ba-8049-353bfcb5e171",
    TransactionId = "quod",
});
...
var res = await sdk.CashFlow.GetBankTransactionCategoryAsync(new GetBankingTransactionCategoryRequest() {
    CompanyId = "8a210b68-6988-11ed-a1eb-0242ac120002",
    ConnectionId = "2e9d2c44-f675-40ba-8049-353bfcb5e171",
...
var res = await sdk.CashFlow.GetEnhancedCashFlowTransactionsAsync(new GetEnhancedCashFlowTransactionsRequest() {
    CompanyId = "8a210b68-6988-11ed-a1eb-0242ac120002",
    Page = 1,
    PageSize = 100,
    Query = "esse",
...
| Parameter                                                                                                   | Type                                                                                                        | Required                                                                                                    | Description                                                                                                 |
| ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| `request`                                                                                                   | [GetEnhancedCashFlowTransactionsRequest](../../models/operations/GetEnhancedCashFlowTransactionsRequest.md) | :heavy_check_mark:                                                                                          | The request object to use for the request.                                                                  |


### Response

**[GetEnhancedCashFlowTransactionsResponse](../../models/operations/GetEnhancedCashFlowTransactionsResponse.md)**
...
var res = await sdk.CashFlow.ListBankAccountBalancesAsync(new ListBankingAccountBalancesRequest() {
    CompanyId = "8a210b68-6988-11ed-a1eb-0242ac120002",
    ConnectionId = "2e9d2c44-f675-40ba-8049-353bfcb5e171",
...
var res = await sdk.CashFlow.ListBankAccountsAsync(new ListBankingAccountsRequest() {
    CompanyId = "8a210b68-6988-11ed-a1eb-0242ac120002",
    ConnectionId = "2e9d2c44-f675-40ba-8049-353bfcb5e171",
    OrderBy = "-modifiedDate",
    Page = 1,
...
var res = await sdk.CashFlow.ListBankTransactionCategoriesAsync(new ListBankingTransactionCategoriesRequest() {
    CompanyId = "8a210b68-6988-11ed-a1eb-0242ac120002",
    ConnectionId = "2e9d2c44-f675-40ba-8049-353bfcb5e171",
    OrderBy = "-modifiedDate",
    Page = 1,
...
var res = await sdk.CashFlow.ListBankTransactionsAsync(new ListBankingTransactionsRequest() {
    CompanyId = "8a210b68-6988-11ed-a1eb-0242ac120002",
    ConnectionId = "2e9d2c44-f675-40ba-8049-353bfcb5e171",
    OrderBy = "-modifiedDate",
    Page = 1,
