...
<!-- UsageSnippet language="csharp" operationID="list-banking-accounts" method="get" path="/companies/{companyId}/connections/{connectionId}/data/banking-accounts" -->
```csharp
using Codat.Lending;
...
<!-- UsageSnippet language="csharp" operationID="get-banking-account" method="get" path="/companies/{companyId}/connections/{connectionId}/data/banking-accounts/{accountId}" -->
```csharp
using Codat.Lending;
using Codat.Lending.Models.Components;
using Codat.Lending.Models.Requests;
