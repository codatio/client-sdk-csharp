...
var res = await sdk.FinancialStatementsBalanceSheet.GetAsync(new GetAccountingBalanceSheetRequest() {
...
var res = await sdk.FinancialStatementsBalanceSheet.GetCategorizedAccountsAsync(new GetCategorizedBalanceSheetStatementRequest() {
    CompanyId = "8a210b68-6988-11ed-a1eb-0242ac120002",
