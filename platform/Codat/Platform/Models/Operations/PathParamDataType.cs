...
namespace Codat.Platform.Models.Operations
{
    ...
    public static class PathParamDataTypeExtension
    {
        public static string Value(this PathParamDataType value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static PathParamDataType ToEnum(this string value)
        {
            foreach(var field in typeof(PathParamDataType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is PathParamDataType)
                    {
                        return (PathParamDataType)enumVal;
                    }
                }
            }
