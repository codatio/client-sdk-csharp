...
namespace Codat.Platform
{
    ...
    public interface IGroups
    {
        ...
        /// </remarks>
        /// </summary>
        Task<CreateGroupResponse> CreateGroupAsync(GroupPrototype? request = null);
    ...
    public class Groups: IGroups
    {
        ...
        public async Task<CreateGroupResponse> CreateGroupAsync(GroupPrototype? request = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerDetails();
