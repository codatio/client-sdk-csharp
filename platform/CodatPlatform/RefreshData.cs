...
namespace CodatPlatform
{
    ...
    public interface IRefreshDataSDK
    {
        ...
        /// 
        /// <remarks>
        /// The *List pull operations* endpoint returns a list of <a href="https://docs.codat.io/platform-api#/schemas/PullOperation">pull operations</a> made by your client.<br/>
        /// <br/>
        /// A <a href="https://docs.codat.io/platform-api#/schemas/PullOperation">pull operation</a> is a request to retrieve a specific data type from an integration.<br/>
        /// <br/>
        /// ### Tips and traps<br/>
        /// <br/>
