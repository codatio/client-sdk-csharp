...
namespace Codat.Sync.Payables.V1
{
    ...
    public interface IBillPayments
    {
        ...
        /// </remarks>
        /// </summary>
        Task<Models.Operations.CreateBillPaymentResponse> CreateAsync(CreateBillPaymentRequest request, RetryConfig? retryConfig = null);
    ...
    public class BillPayments: IBillPayments
    {
        ...
        public BillPayments(ISpeakeasyHttpClient client, Func<Codat.Sync.Payables.V1.Models.Shared.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<Models.Operations.CreateBillPaymentResponse> CreateAsync(CreateBillPaymentRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Models.Shared.CreateBillPaymentResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<ListBillPaymentsResponse> ListAsync(ListBillPaymentsRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Models.Shared.BillPayments>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
