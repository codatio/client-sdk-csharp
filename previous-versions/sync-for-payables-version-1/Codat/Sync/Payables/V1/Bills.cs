...
namespace Codat.Sync.Payables.V1
{
    ...
    public interface IBills
    {
        ...
        /// </remarks>
        /// </summary>
        Task<Models.Operations.CreateBillResponse> CreateAsync(CreateBillRequest request, RetryConfig? retryConfig = null);
        ...
        /// </remarks>
        /// </summary>
        Task<Models.Operations.UpdateBillResponse> UpdateAsync(UpdateBillRequest request, RetryConfig? retryConfig = null);
    ...
    public class Bills: IBills
    {
        ...
        public Bills(ISpeakeasyHttpClient client, Func<Codat.Sync.Payables.V1.Models.Shared.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<Models.Operations.CreateBillResponse> CreateAsync(CreateBillRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Models.Shared.CreateBillResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<ListBillsResponse> ListAsync(ListBillsRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Models.Shared.Bills>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<Models.Operations.UpdateBillResponse> UpdateAsync(UpdateBillRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/connections/{connectionId}/push/bills/{billId}", request);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Models.Shared.UpdateBillResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
