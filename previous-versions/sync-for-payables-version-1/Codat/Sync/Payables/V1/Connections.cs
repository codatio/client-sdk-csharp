...
namespace Codat.Sync.Payables.V1
{
    ...
    public class Connections: IConnections
    {
        ...
        public Connections(ISpeakeasyHttpClient client, Func<Codat.Sync.Payables.V1.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
