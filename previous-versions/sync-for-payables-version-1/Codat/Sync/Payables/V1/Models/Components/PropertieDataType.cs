...
namespace Codat.Sync.Payables.V1.Models.Components
{
    ...
    public static class PropertieDataTypeExtension
    {
        public static string Value(this PropertieDataType value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static PropertieDataType ToEnum(this string value)
        {
            foreach(var field in typeof(PropertieDataType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is PropertieDataType)
                    {
                        return (PropertieDataType)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum PropertieDataType");
        }
    }
