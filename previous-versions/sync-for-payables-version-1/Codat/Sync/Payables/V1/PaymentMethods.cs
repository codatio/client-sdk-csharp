...
namespace Codat.Sync.Payables.V1
{
    ...
    public class PaymentMethods: IPaymentMethods
    {
        ...
        public PaymentMethods(ISpeakeasyHttpClient client, Func<Codat.Sync.Payables.V1.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<ListPaymentMethodsResponse> ListAsync(ListPaymentMethodsRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Models.Components.PaymentMethods>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
