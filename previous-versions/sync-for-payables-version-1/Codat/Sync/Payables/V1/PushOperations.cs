...
namespace Codat.Sync.Payables.V1
{
    ...
    public class PushOperations: IPushOperations
    {
        ...
        public PushOperations(ISpeakeasyHttpClient client, Func<Codat.Sync.Payables.V1.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
