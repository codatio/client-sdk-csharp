...
namespace Codat.Sync.Payables.V1
{
    ...
    public class Suppliers: ISuppliers
    {
        ...
        public async Task<GetCreateUpdateSupplierModelResponse> GetCreateUpdateModelAsync(GetCreateUpdateSupplierModelRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            ...
            var hookCtx = new HookContext("get-create-update-supplier-model", null, _securitySource);
