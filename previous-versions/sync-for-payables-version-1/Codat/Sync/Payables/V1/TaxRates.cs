...
namespace Codat.Sync.Payables.V1
{
    ...
    public class TaxRates: ITaxRates
    {
        ...
        public TaxRates(ISpeakeasyHttpClient client, Func<Codat.Sync.Payables.V1.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<ListTaxRatesResponse> ListAsync(ListTaxRatesRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Models.Components.TaxRates>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
