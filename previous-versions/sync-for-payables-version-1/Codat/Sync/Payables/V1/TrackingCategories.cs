...
namespace Codat.Sync.Payables.V1
{
    ...
    public class TrackingCategories: ITrackingCategories
    {
        ...
        public TrackingCategories(ISpeakeasyHttpClient client, Func<Codat.Sync.Payables.V1.Models.Shared.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
