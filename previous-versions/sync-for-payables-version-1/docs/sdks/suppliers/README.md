...
| Parameter                                                                                           | Type                                                                                                | Required                                                                                            | Description                                                                                         |
| --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| `request`                                                                                           | [GetCreateUpdateSupplierModelRequest](../../Models/Requests/GetCreateUpdateSupplierModelRequest.md) | :heavy_check_mark:                                                                                  | The request object to use for the request.                                                          |

### Response

**[GetCreateUpdateSupplierModelResponse](../../Models/Requests/GetCreateUpdateSupplierModelResponse.md)**
...
CreateSupplierRequest req = new CreateSupplierRequest() {
    ...
    Supplier = new Supplier() {
        ...
        Addresses = new List<Address>() {
            new Address() {
                Type = Codat.Sync.Payables.V1.Models.Components.AccountingAddressType.Billing,
                Line1 = "Unit 51",
        ...
        TaxNumber = "string",
        Status = Codat.Sync.Payables.V1.Models.Components.SupplierStatus.Unknown,
