...
using Codat.Utils;
    ...
    /// </summary>
        ...
        internal static HttpRequestMessage BuildHttpRequestMessage(string operationId, GetCommerceLifetimeValueMetricsRequest value, string baseUrl)
        {
            if("get-commerce-lifetime-value-metrics" == operationId)
            {
                ...
                var message = new HttpRequestMessage(HttpMethod.Get, baseUrl + $"/data/companies/{companyId}/connections/{connectionId}/assess/commerceMetrics/lifetimeValue" + queryParamString);
                return message;
            }
