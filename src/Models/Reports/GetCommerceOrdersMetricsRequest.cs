...
public class GetCommerceOrdersMetricsRequest
{
    ...
    internal static HttpRequestMessage BuildHttpRequestMessage(string operationId, GetCommerceOrdersMetricsRequest value, string baseUrl)
    {
        if("get-commerce-orders-metrics" == operationId)
        {
            ...
            var message = new HttpRequestMessage(HttpMethod.Get, baseUrl + $"/data/companies/{companyId}/connections/{connectionId}/assess/commerceMetrics/orders" + queryParamString);
            return message;
        }
