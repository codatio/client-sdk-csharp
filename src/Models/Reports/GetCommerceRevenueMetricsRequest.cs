...
public class GetCommerceRevenueMetricsRequest
{
    ...
    internal static HttpRequestMessage BuildHttpRequestMessage(string operationId, GetCommerceRevenueMetricsRequest value, string baseUrl)
    {
        if("get-commerce-revenue-metrics" == operationId)
        {
            ...
            var message = new HttpRequestMessage(HttpMethod.Get, baseUrl + $"/data/companies/{companyId}/connections/{connectionId}/assess/commerceMetrics/revenue" + queryParamString);
            return message;
        }
