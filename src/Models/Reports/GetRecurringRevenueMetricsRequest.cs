...
public class GetRecurringRevenueMetricsRequest
{
    ...
    internal static HttpRequestMessage BuildHttpRequestMessage(string operationId, GetRecurringRevenueMetricsRequest value, string baseUrl)
    {
        if("get-recurring-revenue-metrics" == operationId)
        {
            ...
            var message = new HttpRequestMessage(HttpMethod.Get, baseUrl + $"/data/companies/{companyId}/connections/{connectionId}/assess/subscriptions/mrr");
            return message;
        }
