...
namespace Codat.Sync.Commerce
{
    ...
    public interface IAdvancedControls
    {
        ...
        /// </remarks>
        /// </summary>
        Task<ListCompaniesResponse> ListCompaniesAsync(ListCompaniesRequest? request = null, RetryConfig? retryConfig = null);
    ...
    public class AdvancedControls: IAdvancedControls
    {
        ...
        public async Task<ListCompaniesResponse> ListCompaniesAsync(ListCompaniesRequest? request = null, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Companies>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
