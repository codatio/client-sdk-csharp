...
namespace Codat.Sync.Commerce.Models.Components
{
    ...
    /// <summary>
    /// A connection represents a <a href="https://docs.codat.io/sync-for-sync-for-commerce-api#/schemas/Company">company&apos;s</a> connection to a data source and allows you to synchronize data (pull and/or push) with that source.<br/>
    /// 
    /// <remarks>
    /// <br/>
