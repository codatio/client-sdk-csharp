...
namespace Codat.Sync.Expenses
{
    ...
    public interface IAdjustments
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="CreateAdjustmentTransactionRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="CreateAdjustmentTransactionResponse"/> response envelope when completed.</returns>
        ...
        public  Task<CreateAdjustmentTransactionResponse> CreateAsync(
    ...
    public class Adjustments: IAdjustments
    {
        ...
        /// <exception cref="ErrorMessage">The request made is not valid. Thrown when the API returns a 400, 401, 402, 403, 404, 429, 500 or 503 response.</exception>
        /// <exception cref="SDKException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<CreateAdjustmentTransactionResponse> CreateAsync(
            CreateAdjustmentTransactionRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/companies/{companyId}/sync/expenses/adjustment-transactions", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "create-adjustment-transaction", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    AdjustmentTransactionResponse obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<AdjustmentTransactionResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into AdjustmentTransactionResponse.", httpResponse, httpResponseBody, ex);
                    }
