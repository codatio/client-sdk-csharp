...
namespace Codat.Sync.Expenses
{
    ...
    public interface IBankAccounts
    {
        ...
        /// </remarks>
        /// </summary>
        Task<GetCreateBankAccountsModelResponse> GetCreateModelAsync(GetCreateBankAccountsModelRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class BankAccounts: IBankAccounts
    {
        ...
        public BankAccounts(ISpeakeasyHttpClient client, Func<Codat.Sync.Expenses.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<Models.Requests.CreateBankAccountResponse> CreateAsync(CreateBankAccountRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Models.Components.CreateBankAccountResponse>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
