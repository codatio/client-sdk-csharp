...
namespace Codat.Sync.Expenses
{
    ...
    public interface ICompanyInfo
    {
        ...
        /// </remarks>
        /// </summary>
        Task<GetCompanyInfoResponse> GetAsync(GetCompanyInfoRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class CompanyInfo: ICompanyInfo
    {
        ...
        public CompanyInfo(ISpeakeasyHttpClient client, Func<Codat.Sync.Expenses.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<GetCompanyInfoResponse> GetAsync(GetCompanyInfoRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext("get-company-info", null, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<CompanyInformation>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
