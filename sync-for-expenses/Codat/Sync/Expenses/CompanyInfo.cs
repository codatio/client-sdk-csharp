...
namespace Codat.Sync.Expenses
{
    ...
    public interface ICompanyInfo
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="GetCompanyInfoRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="GetCompanyInfoResponse"/> response envelope when completed.</returns>
        ...
        public  Task<GetCompanyInfoResponse> GetAsync(GetCompanyInfoRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class CompanyInfo: ICompanyInfo
    {
        ...
        /// <exception cref="ErrorMessage">Your API request was not properly authorized. Thrown when the API returns a 401, 402, 403, 404, 409, 429, 500 or 503 response.</exception>
        /// <exception cref="SDKException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<GetCompanyInfoResponse> GetAsync(
        ...
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get-company-info", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    CompanyInformation obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<CompanyInformation>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into CompanyInformation.", httpResponse, httpResponseBody, ex);
                    }
