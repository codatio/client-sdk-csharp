...
namespace Codat.Sync.Expenses.Models.Components
{
    ...
    /// &gt; <br/>
    /// &gt; To view bank account data through the Banking API, please refer to the new <a href="https://docs.codat.io/sync-for-expenses-api#/schemas/Account">Banking: Account</a> data type.<br/>
    /// <br/>
    /// ## Overview<br/>
    /// <br/>
    ...
    public class AccountingBankAccount
    {
        ...
        public CreateBankAccountResponseBankAccountType? AccountType { get; set; }
