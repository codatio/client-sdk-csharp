...
namespace Codat.Sync.Expenses.Models.Components
{
    ...
    /// <br/>
    /// Customers' data links to accounts receivable <a href="https://docs.codat.io/sync-for-expenses-api#/schemas/Invoice">invoices</a>.
    /// </summary>
    [Obsolete("This will be removed in a future release, please migrate away from it as soon as possible")]
    public class UpdateCustomerResponseAccountingCustomer
    {
