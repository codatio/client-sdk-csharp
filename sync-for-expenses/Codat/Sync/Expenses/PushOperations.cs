...
namespace Codat.Sync.Expenses
{
    ...
    public interface IPushOperations
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="ListPushOperationsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="ListPushOperationsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<ListPushOperationsResponse> ListAsync(
        ...
        /// <exception cref="SDKException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<GetPushOperationResponse> GetAsync(GetPushOperationRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class PushOperations: IPushOperations
    {
        ...
        public PushOperations(SDKConfig config)
        {
        ...
        /// <exception cref="ErrorMessage">Your `query` parameter was not correctly formed. Thrown when the API returns a 400, 401, 402, 403, 404, 429, 500 or 503 response.</exception>
        /// <exception cref="SDKException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<ListPushOperationsResponse> ListAsync(
            ListPushOperationsRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list-push-operations", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    Models.Components.PushOperations obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<Models.Components.PushOperations>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into Models.Components.PushOperations.", httpResponse, httpResponseBody, ex);
                    }
        ...
        /// <exception cref="ErrorMessage">Your API request was not properly authorized. Thrown when the API returns a 401, 402, 403, 404, 429, 500 or 503 response.</exception>
        /// <exception cref="SDKException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<GetPushOperationResponse> GetAsync(
