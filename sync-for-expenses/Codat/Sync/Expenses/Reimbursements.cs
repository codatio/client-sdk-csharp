...
namespace Codat.Sync.Expenses
{
    ...
    public interface IReimbursements
    {
        ...
        /// </remarks>
        /// </summary>
        Task<CreateReimbursableExpenseTransactionResponse> CreateReimbursableExpenseTransactionAsync(CreateReimbursableExpenseTransactionRequest request);
        ...
        /// </remarks>
        /// </summary>
        Task<UpdateReimbursableExpenseTransactionResponse> UpdateReimbursableExpenseTransactionAsync(UpdateReimbursableExpenseTransactionRequest request);
    }
    ...
    public class Reimbursements: IReimbursements
    {
        ...
        public async Task<CreateReimbursableExpenseTransactionResponse> CreateReimbursableExpenseTransactionAsync(CreateReimbursableExpenseTransactionRequest request)
        {
        ...
        public async Task<UpdateReimbursableExpenseTransactionResponse> UpdateReimbursableExpenseTransactionAsync(UpdateReimbursableExpenseTransactionRequest request)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerDetails();
