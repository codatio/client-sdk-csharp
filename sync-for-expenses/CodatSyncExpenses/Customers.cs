    ...
    public class Customers: ICustomers
    {
        ...
        public async Task<ListCustomersResponse> ListAsync(ListCustomersRequest? request = null)
        {
            ...
            if((response.StatusCode == 200))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.Customers = JsonConvert.DeserializeObject<Models.Shared.Customers>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
