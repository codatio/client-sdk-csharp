...
namespace CodatSyncExpenses
{
    ...
    public class SyncSDK: ISyncSDK
    {
        ...
        private const string _sdkVersion = "3.1.1";
        private const string _sdkGenVersion = "2.150.0";
        private const string _openapiDocVersion = "prealpha";
        private const string _userAgent = "speakeasy-sdk/csharp 3.1.1 2.150.0 prealpha Codat.Sync.Expenses";
        ...
        public async Task<InitiateSyncResponse> InitiateSyncAsync(InitiateSyncRequest? request = null)
        {
            ...
            if((response.StatusCode == 202))
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {
                    response.SyncInitiated = JsonConvert.DeserializeObject<Dictionary<string, object>>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
