...
namespace Codat.Sync.Payables.Models.Shared
{
    ...
    /// <summary>
    /// &gt; **Language tip:** For line items, or individual transactions, of a company&apos;s financial documents, refer to the <a href="https://docs.codat.io/sync-for-payables-api#/schemas/JournalEntry">Journal entries</a> data type<br/>
    /// 
    /// <remarks>
    /// <br/>
    ...
    /// ## Overview<br/>
    /// <br/>
    /// In accounting software, journals are used to record all the financial transactions of a company. Each transaction in a journal is represented by a separate <a href="https://docs.codat.io/sync-for-payables-api#/schemas/JournalEntry">journal entry</a>. These entries are used to create the general ledger, which is then used to create the financial statements of a business.<br/>
    /// <br/>
