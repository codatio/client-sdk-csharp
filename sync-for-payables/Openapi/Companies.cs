...
namespace Openapi
{
    ...
    public interface ICompanies
    {
        ...
        /// </remarks>
        /// </summary>
        Task<ListCompaniesResponse> ListAsync(int? page = null, int? pageSize = null, string? query = null, string? orderBy = null, RetryConfig? retryConfig = null);
        ...
        /// </remarks>
        /// </summary>
        Task<UpdateCompanyResponse> UpdateAsync(string companyId, CompanyRequestBody? companyRequestBody = null, RetryConfig? retryConfig = null);
        ...
        /// </remarks>
        /// </summary>
        Task<DeleteCompanyResponse> DeleteAsync(string companyId, RetryConfig? retryConfig = null);
        ...
        /// </remarks>
        /// </summary>
        Task<GetCompanyResponse> GetAsync(string companyId, RetryConfig? retryConfig = null);
    }
    ...
    public class Companies: ICompanies
    {
        ...
        private const string _userAgent = "speakeasy-sdk/csharp 0.0.5 2.411.5 3.0.0 Openapi";
        private string _serverUrl = "";
        private ISpeakeasyHttpClient _client;
        private Func<Openapi.Models.Components.Security>? _securitySource;

        public Companies(ISpeakeasyHttpClient client, Func<Openapi.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<ListCompaniesResponse> ListAsync(int? page = null, int? pageSize = null, string? query = null, string? orderBy = null, RetryConfig? retryConfig = null)
        {
        ...
        public async Task<UpdateCompanyResponse> UpdateAsync(string companyId, CompanyRequestBody? companyRequestBody = null, RetryConfig? retryConfig = null)
        {
        ...
        public async Task<DeleteCompanyResponse> DeleteAsync(string companyId, RetryConfig? retryConfig = null)
        {
        ...
        public async Task<GetCompanyResponse> GetAsync(string companyId, RetryConfig? retryConfig = null)
        {
