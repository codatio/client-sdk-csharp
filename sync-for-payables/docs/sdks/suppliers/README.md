...
<!-- UsageSnippet language="csharp" operationID="update-supplier" method="put" path="/companies/{companyId}/connections/{connectionId}/payables/suppliers/{supplierId}" example="Malformed query" -->
```csharp
using Codat.Sync.Payables;
using Codat.Sync.Payables.Models.Components;
using Codat.Sync.Payables.Models.Requests;
...
<!-- UsageSnippet language="csharp" operationID="update-supplier" method="put" path="/companies/{companyId}/connections/{connectionId}/payables/suppliers/{supplierId}" example="Update supplier" -->
```csharp
using Codat.Sync.Payables;
using Codat.Sync.Payables.Models.Components;
using Codat.Sync.Payables.Models.Requests;
...
<!-- UsageSnippet language="csharp" operationID="update-supplier" method="put" path="/companies/{companyId}/connections/{connectionId}/payables/suppliers/{supplierId}" example="Updated supplier" -->
```csharp
using Codat.Sync.Payables;
using Codat.Sync.Payables.Models.Components;
using Codat.Sync.Payables.Models.Requests;
...
**[UpdateSupplierResponse](../../Models/Requests/UpdateSupplierResponse.md)**
