...
namespace Codat.Sync.Payroll
{
    ...
    public interface IManageData
    {
        ...
        /// </remarks>
        /// </summary>
        Task<GetDataStatusResponse> GetDataStatusAsync(GetDataStatusRequest request);
        ...
        /// </remarks>
        /// </summary>
        Task<GetPushOperationResponse> GetPushOperationAsync(GetPushOperationRequest request);
    ...
    public class ManageData: IManageData
    {
        ...
        public async Task<GetDataStatusResponse> GetDataStatusAsync(GetDataStatusRequest request)
        {
        ...
        public async Task<GetPushOperationResponse> GetPushOperationAsync(GetPushOperationRequest request)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
