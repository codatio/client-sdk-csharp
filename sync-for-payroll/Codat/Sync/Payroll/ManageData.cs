...
namespace Codat.Sync.Payroll
{
    ...
    public interface IManageData
    {
        ...
        /// </remarks>
        /// </summary>
        Task<GetDataStatusResponse> GetDataStatusAsync(GetDataStatusRequest request, RetryConfig? retryConfig = null);
        ...
        /// </remarks>
        /// </summary>
        Task<GetPushOperationResponse> GetPushOperationAsync(GetPushOperationRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class ManageData: IManageData
    {
        ...
        public ManageData(ISpeakeasyHttpClient client, Func<Codat.Sync.Payroll.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<GetDataStatusResponse> GetDataStatusAsync(GetDataStatusRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
        ...
        public async Task<GetPushOperationResponse> GetPushOperationAsync(GetPushOperationRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
