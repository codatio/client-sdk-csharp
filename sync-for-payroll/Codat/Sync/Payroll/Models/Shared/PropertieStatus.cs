...
namespace Codat.Sync.Payroll.Models.Shared
{
    ...
    public static class PropertieStatusExtension
    {
        public static string Value(this PropertieStatus value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static PropertieStatus ToEnum(this string value)
        {
            foreach(var field in typeof(PropertieStatus).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is PropertieStatus)
                    {
                        return (PropertieStatus)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum PropertieStatus");
        }
    }
