...
namespace Codat.Sync.Payroll
{
    ...
    public interface ITrackingCategories
    {
        ...
        /// </remarks>
        /// </summary>
        Task<ListTrackingCategoriesResponse> ListAsync(ListTrackingCategoriesRequest request, RetryConfig? retryConfig = null);
        ...
        /// </remarks>
        /// </summary>
        Task<GetTrackingCategoryResponse> GetAsync(GetTrackingCategoryRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class TrackingCategories: ITrackingCategories
    {
        ...
        public TrackingCategories(ISpeakeasyHttpClient client, Func<Codat.Sync.Payroll.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<ListTrackingCategoriesResponse> ListAsync(ListTrackingCategoriesRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Models.Components.TrackingCategories>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<GetTrackingCategoryResponse> GetAsync(GetTrackingCategoryRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
